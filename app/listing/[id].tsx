  ...
  const imageAnimatedStyle = useAnimatedStyle(() => {
    return {
      transform: [
        ...
        {
          // This line scales the image based on the scroll position. When the scroll position is at -IMG_HEIGHT, the scale is 2. As it reaches 0, the scale transitions smoothly to 1 and remains at 1 even if the scroll position increases to IMG_HEIGHT.
